...
export const financialReportingFlows: FinancialReportingQuestionFlow[] = [
  ...
  {
    area: 'related_party_transactions',
    questions: [
      {
        id: 'rpt_001',
        text: 'Does your organization engage in transactions with related parties (subsidiaries, affiliates, key management, shareholders)?',
        type: 'yes_no',
        riskIndicator: 'high',
      },
      {
        id: 'rpt_002',
        text: 'What is the volume and value of related party transactions?',
        type: 'multiple_choice',
        options: ['Minimal (< 5% of revenue)', 'Moderate (5% - 20% of revenue)', 'Significant (20% - 50% of revenue)', 'Very significant (> 50% of revenue)'],
        conditionalOn: { questionId: 'rpt_001', answer: 'yes' },
        riskIndicator: 'high',
      },
      {
        id: 'rpt_003',
        text: 'Do you have a formal policy for identifying, approving, and disclosing related party transactions?',
        type: 'yes_no',
        conditionalOn: { questionId: 'rpt_001', answer: 'yes' },
        riskIndicator: 'high',
      },
      {
        id: 'rpt_004',
        text: 'Are related party transactions conducted at arm\'s length with market-based pricing?',
        type: 'yes_no',
        conditionalOn: { questionId: 'rpt_001', answer: 'yes' },
        riskIndicator: 'high',
      },
      {
        id: 'rpt_005',
        text: 'Do you maintain a comprehensive register of related parties and their relationships?',
        type: 'yes_no',
        conditionalOn: { questionId: 'rpt_001', answer: 'yes' },
        riskIndicator: 'high',
      },
      {
        id: 'rpt_006',
        text: 'Are related party transactions reviewed and approved by independent directors or audit committee?',
        type: 'yes_no',
        conditionalOn: { questionId: 'rpt_001', answer: 'yes' },
        riskIndicator: 'high',
      },
      {
        id: 'rpt_007',
        text: 'Do you have transfer pricing documentation for intercompany transactions?',
        type: 'yes_no',
        conditionalOn: { questionId: 'rpt_001', answer: 'yes' },
        riskIndicator: 'medium',
      },
    ...
    riskLogic: [
      {
        conditions: [
          { questionId: 'rpt_001', answer: 'yes' },
          { questionId: 'rpt_002', answer: ['Significant (20% - 50% of revenue)', 'Very significant (> 50% of revenue)'] },
        ],
        riskTitle: 'Material Related Party Transaction Risk',
        riskDescription: 'Risk of material misstatement due to significant volume of related party transactions requiring proper identification, measurement, and disclosure',
        materialityLevel: 'high',
        suggestedControls: ['Related party register maintenance', 'Transaction approval policies', 'Disclosure checklists', 'Quarterly RPT reviews'],
      },
      {
        conditions: [
          { questionId: 'rpt_001', answer: 'yes' },
          { questionId: 'rpt_003', answer: 'no' },
        ],
        riskTitle: 'Related Party Governance Risk',
        riskDescription: 'Risk of undisclosed or improperly accounted related party transactions due to lack of formal policies and procedures',
        materialityLevel: 'high',
        suggestedControls: ['RPT policy development', 'Related party identification procedures', 'Board approval requirements', 'Annual declarations from key management'],
      },
      {
        conditions: [
          { questionId: 'rpt_001', answer: 'yes' },
          { questionId: 'rpt_004', answer: 'no' },
        ],
        riskTitle: 'Non-Arm\'s Length Transaction Risk',
        riskDescription: 'Risk of misstated financial results due to related party transactions not conducted at arm\'s length or market rates',
        materialityLevel: 'high',
        suggestedControls: ['Transfer pricing policies', 'Independent valuation for significant transactions', 'Benchmarking against market rates', 'Documentation of commercial rationale'],
      },
      {
        conditions: [
          { questionId: 'rpt_001', answer: 'yes' },
          { questionId: 'rpt_006', answer: 'no' },
        ],
        riskTitle: 'Related Party Independence Risk',
        riskDescription: 'Risk of conflicts of interest and inadequate oversight of related party transactions without independent review',
        materialityLevel: 'medium',
        suggestedControls: ['Audit committee oversight', 'Independent director approval', 'Conflict of interest policies', 'Related party transaction committee'],
      },
    ],
  },
  {
    area: 'provisions_contingencies',
    questions: [
      {
        id: 'prov_001',
        text: 'Does your organization have significant provisions or contingent liabilities (litigation, warranties, restructuring, environmental)?',
        type: 'yes_no',
        riskIndicator: 'high',
      },
      {
        id: 'prov_002',
        text: 'What is the value of provisions relative to total liabilities?',
        type: 'multiple_choice',
        options: ['< 5%', '5% - 15%', '15% - 30%', '> 30%'],
        conditionalOn: { questionId: 'prov_001', answer: 'yes' },
        riskIndicator: 'high',
      },
      {
        id: 'prov_003',
        text: 'Are you involved in ongoing litigation or regulatory investigations?',
        type: 'yes_no',
        riskIndicator: 'high',
      },
      {
        id: 'prov_004',
        text: 'Do you have warranty obligations or product liability exposures?',
        type: 'yes_no',
        riskIndicator: 'medium',
      },
      {
        id: 'prov_005',
        text: 'How frequently are provisions reviewed and reassessed?',
        type: 'multiple_choice',
        options: ['Monthly', 'Quarterly', 'Semi-annually', 'Annually', 'Only when events occur'],
        conditionalOn: { questionId: 'prov_001', answer: 'yes' },
        riskIndicator: 'high',
      },
      {
        id: 'prov_006',
        text: 'Do you obtain legal or expert opinions to support provision estimates?',
        type: 'yes_no',
        conditionalOn: { questionId: 'prov_001', answer: 'yes' },
        riskIndicator: 'high',
      },
      {
        id: 'prov_007',
        text: 'Do you have a formal process for identifying and evaluating contingent liabilities?',
        type: 'yes_no',
        riskIndicator: 'high',
      },
      {
        id: 'prov_008',
        text: 'Are provision calculations based on detailed analysis and supportable assumptions?',
        type: 'yes_no',
        conditionalOn: { questionId: 'prov_001', answer: 'yes' },
        riskIndicator: 'high',
      },
    ...
    riskLogic: [
      {
        conditions: [
          { questionId: 'prov_001', answer: 'yes' },
          { questionId: 'prov_002', answer: ['15% - 30%', '> 30%'] },
        ],
        riskTitle: 'Material Provisions Valuation Risk',
        riskDescription: 'Risk of material misstatement in provisions due to significant balances requiring complex estimates and judgments',
        materialityLevel: 'high',
        suggestedControls: ['Provision estimation methodology', 'Expert input and legal opinions', 'Quarterly provision reviews', 'Sensitivity analysis', 'Documentation of assumptions'],
      },
      {
        conditions: [
          { questionId: 'prov_003', answer: 'yes' },
        ],
        riskTitle: 'Litigation and Regulatory Contingency Risk',
        riskDescription: 'Risk of inadequate provisions or disclosures for ongoing litigation and regulatory matters',
        materialityLevel: 'high',
        suggestedControls: ['Legal counsel engagement', 'Litigation tracking system', 'Regular case reviews', 'Disclosure committee', 'Contingency assessment procedures'],
      },
      {
        conditions: [
          { questionId: 'prov_001', answer: 'yes' },
          { questionId: 'prov_005', answer: ['Annually', 'Only when events occur'] },
        ],
        riskTitle: 'Provision Review Frequency Risk',
        riskDescription: 'Risk of outdated or inaccurate provisions due to infrequent reassessment of estimates',
        materialityLevel: 'medium',
        suggestedControls: ['Quarterly provision review process', 'Trigger event identification', 'Provision reconciliation procedures', 'Management review and approval'],
      },
      {
        conditions: [
          { questionId: 'prov_007', answer: 'no' },
        ],
        riskTitle: 'Contingent Liability Identification Risk',
        riskDescription: 'Risk of unrecorded or undisclosed contingent liabilities due to lack of formal identification process',
        materialityLevel: 'high',
        suggestedControls: ['Contingency identification procedures', 'Legal inquiry letters', 'Management representations', 'Cross-functional reviews (legal, operations, finance)', 'Disclosure checklist'],
      },
      {
        conditions: [
          { questionId: 'prov_001', answer: 'yes' },
          { questionId: 'prov_008', answer: 'no' },
        ],
        riskTitle: 'Provision Estimation Methodology Risk',
        riskDescription: 'Risk of unreliable provision estimates due to lack of detailed analysis and supportable assumptions',
        materialityLevel: 'high',
        suggestedControls: ['Standardized estimation methodologies', 'Assumption documentation', 'Historical data analysis', 'Expert consultations', 'Management review and challenge'],
      },
    ],
  },
];
...
export const fraudRiskFlows: FraudQuestionFlow[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: 'fraud_proc_002',
        text: 'Do you operate in countries with weak anti-corruption legislation or high corruption perception index scores?',
        type: 'yes_no',
      },
      {
        id: 'fraud_proc_003',
        text: 'What is the typical size of your procurement contracts?',
        type: 'multiple_choice',
        options: ['< $100K', '$100K - $1M', '$1M - $10M', '> $10M'],
      },
      {
        id: 'fraud_proc_004',
        text: 'Do you procure from vendors in high-risk geographies (countries with weak governance or high corruption)?',
        type: 'yes_no',
      },
      {
        id: 'fraud_proc_005',
        text: 'How would you describe your organization\'s procurement culture and tone at the top?',
        type: 'multiple_choice',
        options: ['Strong ethical culture with clear policies', 'Moderate - policies exist but enforcement varies', 'Weak - limited oversight and accountability', 'Unclear or inconsistent'],
      },
      {
        id: 'fraud_proc_006',
        text: 'What is the volume of procurement transactions processed annually?',
        type: 'multiple_choice',
        options: ['< 500 transactions', '500 - 2,000 transactions', '2,000 - 10,000 transactions', '> 10,000 transactions'],
      },
      {
        id: 'fraud_proc_007',
        text: 'Do you frequently have time-sensitive or emergency procurement projects?',
        type: 'yes_no',
      },
      {
        id: 'fraud_proc_008',
        text: 'Do you have a formal vendor approval and due diligence process?',
        type: 'yes_no',
      },
      {
        id: 'fraud_proc_009',
      ...
      {
        id: 'fraud_proc_010',
        text: 'Do you conduct regular vendor performance reviews and relationship assessments?',
        type: 'yes_no',
      },
      {
        id: 'fraud_proc_011',
        text: 'Is there segregation of duties between procurement, receiving, and payment functions?',
        type: 'yes_no',
      },
    ],
    riskLogic: [
      {
        conditions: [
          ...
          { questionId: 'fraud_proc_008', answer: 'no' },
        ],
        riskTitle: 'High-Value Procurement Fraud Risk',
        riskDescription: 'Risk of fraudulent vendor schemes and kickbacks due to high procurement spend without formal vendor approval processes',
        fraudScheme: 'Shell companies, bid rigging, kickbacks, inflated invoices',
        likelihoodScore: 4,
        impactScore: 4,
        redFlags: ['Vendors with similar addresses', 'Split purchases', 'Sole-source justifications', 'Unusual payment terms'],
        suggestedControls: ['Vendor due diligence', 'Competitive bidding', 'PO approval workflows', 'Vendor master data controls'],
      },
      {
        conditions: [
          { questionId: 'fraud_proc_002', answer: 'yes' },
          { questionId: 'fraud_proc_004', answer: 'yes' },
        ],
        riskTitle: 'Geographic and Legislative Procurement Fraud Risk',
        riskDescription: 'Elevated risk of bribery, corruption, and procurement fraud due to operations in high-risk jurisdictions with weak anti-corruption legislation',
        fraudScheme: 'Facilitation payments, bribery, kickbacks, conflicts of interest, local agent fraud',
        likelihoodScore: 4,
        impactScore: 5,
        redFlags: ['Payments to agents in high-risk countries', 'Unusual consulting fees', 'Lack of contract documentation', 'Vendor relationships with government officials'],
        suggestedControls: ['Enhanced vendor due diligence for high-risk geographies', 'Anti-bribery and corruption policy', 'Third-party risk assessments', 'Country-specific compliance training', 'Contract review and approval processes'],
      },
      {
        conditions: [
          { questionId: 'fraud_proc_003', answer: ['$1M - $10M', '> $10M'] },
          { questionId: 'fraud_proc_007', answer: 'yes' },
        ],
        riskTitle: 'Large Contract and Time-Pressure Fraud Risk',
        riskDescription: 'Risk of procurement fraud in large, time-sensitive contracts where normal controls may be bypassed',
        fraudScheme: 'Emergency procurement fraud, bid rigging, contract splitting, inflated pricing',
        likelihoodScore: 3,
        impactScore: 5,
        redFlags: ['Frequent emergency purchases', 'Waived competitive bidding', 'Retroactive purchase orders', 'Sole-source justifications'],
        suggestedControls: ['Emergency procurement policy with oversight', 'Post-award contract reviews', 'Executive approval for emergency procurements', 'Audit of time-sensitive purchases'],
      },
      {
        conditions: [
          { questionId: 'fraud_proc_005', answer: ['Weak - limited oversight and accountability', 'Unclear or inconsistent'] },
          { questionId: 'fraud_proc_006', answer: ['2,000 - 10,000 transactions', '> 10,000 transactions'] },
        ],
        riskTitle: 'Cultural and Volume-Driven Procurement Fraud Risk',
        riskDescription: 'Risk of procurement fraud due to weak organizational culture combined with high transaction volumes that reduce detection likelihood',
        fraudScheme: 'Small-value fraud accumulation, vendor favoritism, kickbacks, ghost vendors',
        likelihoodScore: 4,
        impactScore: 3,
        redFlags: ['Repeat vendors without competitive bidding', 'Employees with vendor relationships', 'Unusual vendor concentration', 'Below-threshold splitting'],
        suggestedControls: ['Tone at the top initiatives', 'Ethics and compliance training', 'Data analytics for fraud detection', 'Vendor rotation policies', 'Whistleblower hotline'],
      },
      {
        conditions: [
          { questionId: 'fraud_proc_009', answer: 'no' },
          { questionId: 'fraud_proc_011', answer: 'no' },
        ],
        riskTitle: 'Weak Procurement Controls Risk',
        riskDescription: 'Risk of procurement fraud due to lack of basic controls including purchase orders and segregation of duties',
        fraudScheme: 'Unauthorized purchases, fictitious vendors, payment fraud, invoice manipulation',
        likelihoodScore: 5,
        impactScore: 3,
        redFlags: ['Purchases without POs', 'Same person ordering and receiving', 'Vendor payments without proper documentation'],
        suggestedControls: ['Mandatory PO requirements', 'Segregation of duties implementation', 'Three-way match (PO, receipt, invoice)', 'Approval workflows'],
      },
    ],
  },
  {
